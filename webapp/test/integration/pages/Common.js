sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("testsmartfilter/testsmartfilter/app", ".html");
		...
		return Opa5.extend("testsmartfilter.testsmartfilter.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["testsmartfilter/testsmartfilter/localService/mockserver"], function (mockserver) {
